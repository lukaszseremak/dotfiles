...
local logins = {
	{ "--addic7ed", os.getenv("ADDIC7ED_USERNAME"), os.getenv("ADDIC7ED_PASSWORD") },
	{ "--opensubtitles", os.getenv("OPENSUBTITLES_USERNAME"), os.getenv("OPENSUBTITLES_PASSWORD") },
}
local bools = {
	auto = true,
	debug = true,
...
local includes = {
	"/home/seremak/Downloads/torrent/",
}
